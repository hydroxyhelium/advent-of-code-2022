...
max_common_number = 11*3*5*7*19*2*13*17

op1 = lambda x: ((x*17)%max_common_number)
op2 = lambda x: ((x+7)%max_common_number)
op3 = lambda x: ((x*x)%max_common_number)
op4 = lambda x: ((x+1)%max_common_number)
op5 = lambda x: (x*3)%max_common_number
op6 = lambda x: ((x+4)%max_common_number)
op7 = lambda x: ((x+8)%max_common_number)
op8 = lambda x: ((x+6)%max_common_number)
